    ...
    return (
        <div>
            ...
            <div className='Select'>
              ...
              <ButtonCountry currentCode={props.currentCode} onChange={props.onChange} country="Argentina" code="ar"/>
              <ButtonCountry currentCode={props.currentCode} onChange={props.onChange} country="Belgium" code="be"/>
              <ButtonCountry currentCode={props.currentCode} onChange={props.onChange} country="Canada" code="ca"/>
              ...
              <ButtonCountry currentCode={props.currentCode} onChange={props.onChange} country="Italy" code="it"/>
